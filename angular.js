      ...
      for(var i = 0, ii = directives.length; i < ii; i++) {
        ...
        if (directiveValue = directive.transclude) {
          ...
          if (directiveValue == 'element') {
            ...
            $compileNode = templateAttrs.$$element = jqLite(document.createComment(''));
 ...
 */
var ngIfDirective = ['$animate', '$document', function($animate, $document) {
  return {
    transclude: 'element',
    priority: 600,
    terminal: true,
    ...
    link: function ($scope, $element, $attr, ctrl, $transclude) {
        ...
        var ngIf = $attr.ngIf || $attr.ejsIf;
        $scope.$watch(ngIf, function ngIfWatchAction(value) {
          if (toBoolean(value)) {
            if (!childScope) {
              childScope = $scope.$new();
 ...
 */
var ngRepeatDirective = ['$parse', '$animate', '$document', function($parse, $animate, $document) {
...
var styleDirective = valueFn({
  ...
  //+ node.js support
  global.angular = arguments.callee;
})(window, document);
